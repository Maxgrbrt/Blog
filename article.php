...
// On récupére l'id de l'article en question dans une variable pour le modifier
                if ($_GET['action'] == 'Modifier') {
                    $id_article = $_GET['id_article'];
                    // On avertit l'utilisateur que l'article a été modifié
                    $notification = '<strong>Félicitations, votre article est Modifié</strong>';
                } else {
                    // On avertit l'utilisateur que l'article a été ajouté
                    $notification = '<strong>Félicitations, votre article est ajouté</strong>';
                }
